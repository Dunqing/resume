...
export const generateComponents = ({
  ...
  return {
    ...
    'th': ({ className, ...props }) => {
      return <th className={clsx('border p-2 border-dark', 'dark:border-dark-100', className)} {...props as any} />
    },
    'td': ({ className, ...props }) => {
      return <td className={clsx('border p-2 border-dark', 'dark:border-dark-100', className)} {...props as any}/>
    },
