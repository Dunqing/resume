...
export const isTag = (t: any, tagName: string | string[]) => is(t, { type: 'element' }) && [tagName].flat().includes((t as Element).tagName)
...
export const isImage = (t: any): t is Element => is(t, { type: 'element', tagName: 'img' })
